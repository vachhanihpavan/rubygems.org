class OwnersController < ApplicationController
  ...
  before_action :render_verify_password, unless: :password_session_active?, only: %i[index create destroy]
  ...
  def render_verify_password
    @redirect_uri = rubygem_owners_url(@rubygem)
    render "passwords/verify"
    false
  end
end
